...
public class ControllerJMeter {
    public static HTTPSampler createHttpSampler(String method, String domain, long port, String path) {
        HTTPSampler googleGetSampler = new HTTPSampler();
        googleGetSampler.setDomain(domain);
        googleGetSampler.setPort((int) port);
    ...
    public static LoopController createLoopController(long loops) {
        LoopController loopCtrl = new LoopController();
        loopCtrl.setLoops((int)loops);
    ...
    public static SetupThreadGroup createSetupThreadGroup(LoopController loopCtrl, int numThreads, int rampUp, long duration, String name) {
