...
import rga.business.entities.APIResponse;
...
public class APIReportProcessing {
    ...
    public static void generatModuleWiseReportFile(String baseXMLRawXMLFile, String baseXSLfilePath,
        ...
        try {
            ...
            Log.error("Error while reading raw data XML file. Exception:" + e.getMessage());
        } catch (TransformerConfigurationException e) {
            Log.error("Error while reading raw data XML file. Exception:" + e.getMessage());
        } catch (TransformerFactoryConfigurationError e) {
            Log.error("Error while reading raw data XML file. Exception:" + e.getMessage());
        } catch (TransformerException e) {
            Log.error("Error while generating summary report file. Exception:" + e.getMessage());
        } catch (Exception e) {
            Log.error("Error while generating summary report file. Exception:" + e.getMessage());
        }
    }
    ...
    private static void setGlobalParamsInXSL(Transformer trasform, HashMap<String, String> xslGlobalParams) {
        ...
        try {
            ...
            Log.error("Error while setting global parameters for use with XSL. Exception:" + e.getMessage());
        }
    }
    ...
    public static void fetchAPIReportDetail(String rawXMLReportFile) {
        ...
        try {
            ...
            Log.error("Error in fetching up data from XML file. Exception:" + e.getMessage());
        } finally {
            try {
                rawXMLReport.delete();
            } catch (Exception e) {
                Log.error("Error in deleting XML data file. Exception:" + e.getMessage());
            }
        }
    }
    ...
    public static void fetchFailedCasesResultSetOfNode(Document doc, String nodeName) {
        ...
        try {
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    try {
                        ...
                        Log.error("Failed to fetch request type.");
                    ...
                    try {
                        ...
                        Log.error("Failed to fetch Request Header.");
                        apiResponse.setRequestHeader(
                                "NA");
                    }
                    ...
                    try {
                        ...
                        Log.error("Failed to fetch Response Header.");
                        apiResponse.setResponseHeader(
                                "NA");
                    }
                    ...
                    try {
                        ...
                        Log.error("Failed to fetch Request data.");
                    ...
                    try {
                        ...
                        Log.error("Failed to fetch Response data.");
                        apiResponse.setResponseData(
                                "NA");
                    }
            ...
            Log.error("Error while fetching failure data. Exception:" + e.getMessage());
        }
...
/*                if (apiResponse.getUseCaseResult())
                ...
                if (apiResponse.getUseCaseID().equalsIgnoreCase("dashboard")){
                    ...
                    Helper.createDir(resultFolder +"/SubPage");
                    File file = new File(resultFolder +"/SubPage/"+  apiResponse.getUseCaseID() + ".html");
                    if (!file.exists())
                        file.createNewFile();
                    htmlfile = new FileOutputStream(file, false);
                    printhtml = new PrintStream(htmlfile);
            ...
            Log.error("Error while creating failure report. Exception:" + e.getMessage());
        }
    }
    ...
    public static String updateJMXFile(String moduleName, String resulFolder) throws Exception {
        ...
        try {
            if (file.exists()) {
                ...
                Log.info("JMX file does not exist at location:" + file.getAbsolutePath());
                return "";
            }
    ...
    public static void generateSummaryReportFile(String summaryReportFilePath, ArrayList<String[]> moduleReportData, String successRate)
        ...
        try {
            ...
            if (!summaryfile.exists()) {
                ...
                Log.info("Adding content to HTML file. This will occur when a blank file is present. ");
                Log.info("Creating new summary file.");
            }
            ...
            Log.info("Summary report generated at :::::::" + summaryReportFilePath + "/" + "jmetersummaryreport.html");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
                ...
                Log.error("Error in generating Summary File. Exception:" + ex.getMessage());
            }
        }
    }
    ...
    public static void generateSummaryReportFile_New(String summaryReportFilePath, ArrayList<String[]> moduleReportData, String successRate)
        ...
        try {
            dashboardFis = new FileInputStream(Common.resourceDirPath() + "configuration/" + "dashboard.html");
            ...
            Log.error("Error in reading Dashboard HTML file. Exception:" + e.getMessage());
        } finally {
        ...
        String passPercentageData = totalPass + "/" + totalSamples + " (" + String.format("%.2f", passPercentage) + "%)";
        reportData.add("<tr><td>" + Helper.getCurrentDateInReadableFormat() + "</td><td>" + totalLinks + "</td><td>" + "Staging" + "</td><td>" + passPercentageData + "</td></tr>");
        ...
        if (reportData != null && reportData.size() > 0) {
            try {
                ...
                Log.error("Error in deleting report data file. Exception:" + e.getMessage());
            }
            ...
            try {
                ...
                Log.error("Error in writing data to report data file. Exception:" + ex.getMessage());
            } finally {
                if (fw != null)
                    fw.close();
            }
        ...
        try {
            ...
            Log.error("Error in generating Dashboard. Exception:" + ex.getMessage());
        } finally {
            try {
                if (pwSummary != null)
                    pwSummary.close();
